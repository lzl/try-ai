...
Put the content of questions into the 'variables', do not includes in the 'assistant_response'
Ask the first question to the candidate, mark all the steps are done.`,
